...
// el segmento [lang], Next.js usa este not-found de la raíz en vez del de
// app/[lang]/not-found.tsx. Como acá no hay forma de saber el idioma,
// se muestra el mensaje en los dos.
